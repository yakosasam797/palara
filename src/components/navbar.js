    ...
    function render() {
      ...
      <div class="navbar-inner container">
        <a href="#" class="navbar-logo" id="nav-logo">
          ...
          <div class="logo-text">
            <span class="logo-brand">Padival's</span>
            <span class="logo-name">PALARA</span>
          </div>
        </a>
        ...
        <ul class="navbar-links" id="nav-links">
          ...
          <li><a href="#loyalty" class="nav-link">Rewards</a></li>
      ...
      <div class="mobile-drawer" id="mobile-drawer">
        <div class="mobile-drawer-header">
          <span class="logo-icon">🍃</span>
          <span class="logo-name" style="color:var(--color-text-on-dark)">PALARA</span>
        ...
        <ul class="mobile-nav-links">
          ...
          <li><a href="#loyalty" class="mobile-link">🎁 Rewards</a></li>
